...
public class AlunoHerancaEPolimorfismo extends PessoaHerancaEPolimorfismo {
    ...
    public AlunoHerancaEPolimorfismo(){
        super();
    }

    public AlunoHerancaEPolimorfismo(String nome, String endereco, String telefone, String curso){
